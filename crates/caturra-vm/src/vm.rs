...
use caturra_classfile::{ClassFile, MethodAccessFlags};
...
pub enum VmError {
    ...
    #[error("unsupported bytecode instruction {0:#04x} (not yet implemented by the caturra VM)")]
...
mod tests {
    ...
    use caturra_classfile::{ClassFile, Constant};
